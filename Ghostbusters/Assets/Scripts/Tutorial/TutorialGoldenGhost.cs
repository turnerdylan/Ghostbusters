...
public enum TUTORIAL_GOLDEN_STATE
{
    NORMAL,
    RUNNING,
};
...
public class TutorialGoldenGhost : MonoBehaviour
{
    //private variables
    ...
    public void SplitApart()
    {
        ...
        {
            var newSmallGhost = Instantiate(TutorialGhostManager.Instance.goldenGhostPrefab, transform.position, Quaternion.identity);
        ...
        TutorialGhostManager.Instance.goldenGhostsInScene.Remove(this.gameObject);
        TutorialChaosManager.Instance.PickChaosEvent(chaosEventIndex, transform.position);
